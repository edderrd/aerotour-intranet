...
<html>  
  ...
  <body>  
    ...
    <ul class="menu">  
      ...
      <li><a href="tools/winddirection.html" class="arrow icon iicon"><em class="ii-gear2"></em> Wind Direction Calculator</a></li>
      <li><a href="tools/windspeed.html" class="arrow icon iicon"><em class="ii-gear2"></em> Wind Speed Calculator</a></li>
    </ul>  
  </body>  
</html>